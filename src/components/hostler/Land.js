...
const Land = () => {
    ...
    const find = async () => {
      try {
        const res = await axios.get(
          "https://hostlebackend.onrender.com/api/studentnumber",
          headers
        );
  ...
  const handleFinde = async (event) => {
    ...
    try {
      ...
      let response = await axios.post(
        "https://hostlebackend.onrender.com/api/checkattendence",
        formJson,
        headers
      );
      setLoading(false);
  ...
  const handleRemove = async (event) => {
    ...
    try {
      setLoading(true);
      let response = await axios.post(
        "https://hostlebackend.onrender.com/api/updatestudent",
        formJson,
        headers
      );
      setLoading(false);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      setLoading(true);
      let response = await axios.post(
        "https://hostlebackend.onrender.com/api/addstudent",
        formJson,
        headers
      );
      setLoading(false);
      ...
      <div className={css.container}>
        ...
        <div className={css.row1}>
          <div className={css.box} onClick={openForm}>
            ...
            <p>
              Click here to add More student to the records.currently there are{" "}
              <small>student</small>
            </p>
          </div>
